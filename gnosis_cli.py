...
from core.utils.contract.contract_console_data import ConsoleContractData
...
console_contract_artifacts.add_contract_artifacts(contract_artifacts_assests, alias='Gnosis-Safe(v1.1.0)')
